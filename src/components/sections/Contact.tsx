...
const fieldClassName = cn(
  ...
  "bg-[#F5F5F5] px-5 py-3 text-sm text-[#111827] sm:text-[15px] dark:bg-white/5 dark:text-white",
  "outline-none placeholder:text-[#64748B] dark:placeholder:text-[#94A3B8]",
  "transition-[box-shadow,background-color,border-color] duration-200",
  "focus:border-[#16A34A]/40 focus:bg-white dark:focus:bg-white/10",
...
export function Contact() {
  ...
  return (
    <section
      ...
      className="bg-[#F5F5F7] py-12 sm:py-14 md:py-16 lg:py-20 dark:bg-white/5"
        ...
        <div className="grid items-start gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:gap-12 xl:gap-16">
          ...
          <Reveal variants={fadeUpBlur} className="pt-0 lg:pt-1">
            <div className="max-w-xl">
              <h2
                id="contact-heading"
                className="text-[1.9rem] font-medium leading-[1.15] tracking-[-0.03em] text-[#050505] sm:text-[2.1rem] md:text-[2.35rem] lg:text-[2.5rem] xl:text-[2.65rem] dark:text-white"
              >
                {landingContact.heading}
              </h2>

              <p className="mt-5 max-w-lg text-sm leading-6 text-[#111827] sm:mt-6 sm:text-base sm:leading-7 dark:text-white">
              ...
              >
                {landingContactInfo.map((item) => {
                  ...
                  const content = (
                    <>
                      <span className="block text-lg font-semibold tracking-tight text-[#050505] sm:text-xl dark:text-white">
                        {item.label}
                      </span>

                      <span className="mt-1.5 block text-sm leading-5 text-[#475569] sm:text-base sm:leading-6 dark:text-[#94A3B8]">
                        {item.value}
                      </span>
                    </>
                  );
                        ...
                        >
                          <span
                            className={cn(
                              ...
                              "rounded-[20px] border border-[#E1E1E1] bg-white dark:border-white/10 dark:bg-[#111A2E]",
          ...
          <Reveal variants={fadeUpBlur}>
            <div className="rounded-[20px] border border-[#DEDEDE] bg-white p-5 shadow-[0_1px_2px_rgba(0,0,0,0.02)] sm:rounded-[22px] sm:p-6 md:p-7 lg:p-8 dark:border-white/10 dark:bg-[#111A2E]">
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="grid gap-5 sm:grid-cols-2">
                  <div>
                    <label
                      htmlFor="firstName"
                      className="mb-2.5 block text-sm font-medium text-[#080808] dark:text-white"
                    >
